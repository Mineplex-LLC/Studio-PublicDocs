...
Follow along with us by checking out the 🔗 [source code](https://github.com/Mineplex-LLC/StudioExample-Dragons)
...
🔗 [DragonsPlugin class source code](https://github.com/Mineplex-LLC/StudioExample-Dragons/blob/master/src/main/java/com/mineplex/studio/dragons/DragonsPlugin.java)
...
<Step>
    ...
    <StepItem title="Load the Lobby World">
        ...
        🔗 [You can find our Lobby world in the example project](https://github.com/Mineplex-LLC/StudioExample-Dragons/tree/master/assets/world-templates)
...
🔗 [DragonsPlugin class source code](https://github.com/Mineplex-LLC/StudioExample-Dragons/blob/master/src/main/java/com/mineplex/studio/dragons/game/DragonsGame.java)
