...
<Step>
    ...
    <StepItem title="Create the `DragonsWorldHolder` Class">
        ...
        🔗 [DragonsWorldHolder class source code](https://github.com/Mineplex-LLC/StudioExample-Dragons/blob/master/src/main/java/com/mineplex/studio/dragons/game/world/DragonsWorldHolder.java)
    </StepItem>
