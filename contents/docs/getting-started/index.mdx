...
This guide will walk you through the process of creating your first project, building it, and deploying it to Mineplex.
...
The CLI also adds a few `.yaml` files automatically that hold your game configuration. You can define things player count constraints, matchmaking rules, product offerings for players, and more in these files. For more information, see the [configuration documentation](/docs/getting-started/game-config).
